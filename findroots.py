...
This module implements methods for root-finding from calculus.py, including the secant and bisection
methods, using both SciPy and pure Python implementations. It also provides utilities for function
visualization and accuracy analysis of root-finding methods.
Functions:
